    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result result)
    {
        ...
        switch (call.method)
        {
            case START_FOREGROUND_SERVICE:
                ...
                // Send error after trying to start service
                // So android doesn't kill us.
            ...
            case START_PERIODIC_TASK:
                ...
                context.startService(serviceAction);
                // Send after startService so if the service was starting
                // it still starts.
            ...
            case STOP_PERIODIC_TASK:
                ...
                context.startService(serviceAction);
                // Send after intent sent to avoid race issues.
